...
<div class="signup__container">
    ...
    <div class="container__child signup__form">
      ...
      <input class="form-control" type="name" name="name" id="name" placeholder="user name" required value="{{ old('name') }}">
            @if ($errors->has('name'))
      ...
      <div class="form-group">
        ...
        <div class="form-group">
           <label for="password_confirmation" >Confirm Password</label>
                            ...
                            <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="Conform_password" >
